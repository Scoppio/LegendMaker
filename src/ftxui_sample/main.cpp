...
// configuration step. It creates a namespace called `LegendMaker`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", LegendMaker::cmake::project_name, LegendMaker::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", LegendMaker::cmake::project_version);
      return EXIT_SUCCESS;
    }
